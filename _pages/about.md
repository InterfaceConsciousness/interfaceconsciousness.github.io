...
Our lab **rethinks consciousness** as the phenomenological bridge enacted through an agent’s interface with a relational substrate (RS). This approach leverages philosophical reasoning, mathematical phenomenology, and modern AI techniques to create a constellation of research projects that are _theoretically robust, empirically grounded, and computationally implementable_. 
